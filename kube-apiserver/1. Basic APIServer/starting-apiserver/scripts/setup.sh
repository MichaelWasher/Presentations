...
export CA_DATA=`cat "${PKI}/ca.crt" | base64`
export KUBECONFIG_CERT_DATA=`cat "${PKI}/server.crt" | base64`
export KUBECONFIG_KEY_DATA=`cat "${PKI}/server.key"  | base64`

cat "${PKI}/kubconfig_template" | envsubst > kubeconfig
cd -
